class Game {
  ...
  start() {
    ...
    rocket1 = createSprite(width / 2 - 100, height - 100);
    rocket1.addImage("rocket1", rocket1_img);
    rocket1.scale = 0.25;

    rocket2 = createSprite(width / 2 + 150, height - 100);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //use data form the database to display the rockets in x and y direction
  ...
  showRank() {
    swal({
      ...
      imageUrl:
        "https://raw.githubusercontent.com/vishalgaddam873/p5-multiplayer-rocket-race-game/master/assets/cup.png",
      imageSize: "100x100",
